"""
Django settings for utest_10 project.
...
WSGI_APPLICATION = 'utest_10.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "utest_10 API",
    "DESCRIPTION": "API documentation for utest_10 App",
    "VERSION": "v1",
}
